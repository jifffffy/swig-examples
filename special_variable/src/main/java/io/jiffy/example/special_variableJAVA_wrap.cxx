...
namespace Swig {
  namespace {
    jclass jclass_special_variableJNI = NULL;
...
#include "special_variableJAVA_wrap.h"
...
void SwigDirector_Callback::run() {
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    jenv->CallStaticVoidMethod(Swig::jclass_special_variableJNI, Swig::director_method_ids[0], swigjobj);
...
SWIGEXPORT void JNICALL Java_io_jiffy_example_special_1variableJNI_delete_1Callback(JNIEnv *jenv, jclass jcls, jlong jarg1) {
...
SWIGEXPORT void JNICALL Java_io_jiffy_example_special_1variableJNI_Callback_1run(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  Callback *arg1 = (Callback *) 0 ;
...
SWIGEXPORT void JNICALL Java_io_jiffy_example_special_1variableJNI_Callback_1runSwigExplicitCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  Callback *arg1 = (Callback *) 0 ;
...
SWIGEXPORT jlong JNICALL Java_io_jiffy_example_special_1variableJNI_new_1Callback(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  Callback *result = 0 ;
...
SWIGEXPORT void JNICALL Java_io_jiffy_example_special_1variableJNI_Callback_1director_1connect(JNIEnv *jenv, jclass jcls, jobject jself, jlong objarg, jboolean jswig_mem_own, jboolean jweak_global) {
...
SWIGEXPORT void JNICALL Java_io_jiffy_example_special_1variableJNI_Callback_1change_1ownership(JNIEnv *jenv, jclass jcls, jobject jself, jlong objarg, jboolean jtake_or_release) {
  Callback *obj = *((Callback **)&objarg);
...
SWIGEXPORT jlong JNICALL Java_io_jiffy_example_special_1variableJNI_new_1Caller(JNIEnv *jenv, jclass jcls) {
  jlong jresult = 0 ;
  Caller *result = 0 ;
...
SWIGEXPORT void JNICALL Java_io_jiffy_example_special_1variableJNI_delete_1Caller(JNIEnv *jenv, jclass jcls, jlong jarg1) {
...
SWIGEXPORT void JNICALL Java_io_jiffy_example_special_1variableJNI_Caller_1delCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  Caller *arg1 = (Caller *) 0 ;
...
SWIGEXPORT void JNICALL Java_io_jiffy_example_special_1variableJNI_Caller_1setCallback(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jobject jarg2_) {
  Caller *arg1 = (Caller *) 0 ;
...
SWIGEXPORT void JNICALL Java_io_jiffy_example_special_1variableJNI_Caller_1call(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  Caller *arg1 = (Caller *) 0 ;
...
SWIGEXPORT void JNICALL Java_io_jiffy_example_special_1variableJNI_swig_1module_1init(JNIEnv *jenv, jclass jcls) {
  int i;
  ...
  Swig::jclass_special_variableJNI = (jclass) jenv->NewGlobalRef(jcls);
  if (!Swig::jclass_special_variableJNI) return;
