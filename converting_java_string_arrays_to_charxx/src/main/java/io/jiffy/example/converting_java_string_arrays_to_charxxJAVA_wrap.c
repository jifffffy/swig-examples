...
SWIGEXPORT jint JNICALL Java_io_jiffy_example_converting_1java_1string_1arrays_1to_1charxxJNI_print_1args(JNIEnv *jenv, jclass jcls, jobjectArray jarg1) {
  jint jresult = 0 ;
  char **arg1 = (char **) 0 ;
  jint size1 ;
  int result;
...
SWIGEXPORT jobjectArray JNICALL Java_io_jiffy_example_converting_1java_1string_1arrays_1to_1charxxJNI_get_1args(JNIEnv *jenv, jclass jcls) {
